...
ensemble_24hours_1 = read.table("E:/output/final_analysis/144hours/ensemble_144hours.txt", sep = "\t", header = T)
...
check = check[,56:58]
write.table(check, "crps_144h_raw_forecast.txt", sep = "\t", col.names = T, row.names = F)
